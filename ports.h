 ...
 * Header file for all the ports that show what pin they are
...
// Port 2 Pins
#define SLOW_CLK              (0x01) // 2.0 SLOW CLK
#define CHECK_BAT              (0x02) // 2.1 CHECK_BAT
#define IR_LED                 (0x04) // 2.2 IR LED
#define SW2                (0x08) // 2.3 GP_I/O
#define IOT_RUN_CPU            (0x10) // 2.4 IOT_RUN_CPU
#define DAC_ENB                (0x20) // 2.5 DAC_ENB
#define LFXOUT                 (0x40) // 2.6 GP_I/O
...
#define IOT_EN_CPU              (0x80) // 3.7 IOT_EN_CPU             1
...
#define R_REVERSE              (0x08) // 6.3 P6_1_PWM
